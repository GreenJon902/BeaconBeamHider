...
public class ShowBeaconsCommand implements CommandExecutor {
    BeaconBeamHider beaconBeamHider;
    Config config;
    PlayerExcludeList playerExcludeList;

    public ShowBeaconsCommand(BeaconBeamHider beaconBeamHider, Config config, PlayerExcludeList playerExcludeList) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        player.sendMessage(Component.text("Beacons in your current chunk have been shown!"));
